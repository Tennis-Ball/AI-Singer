from song_modules.midi_to_text import data_parse
from song_modules.text_to_midi import data_form
from song_modules.data_collector import data_format
from song_modules.split_sequence import split_sequence
...
def make_song(length, epochs, batch_size):
